...
Jii.defineClass('Jii.base.ActiveRecord', /** @lends Jii.base.ActiveRecord.prototype */{
    ...
    get: function (name) {
        if (this.hasRelation(name)) {
            var relation = this.getRelation(name);
            return this._related[name] || (relation.multiple ? [] : null);
        }
    ...
    set: function (name, value) {
        if (this.hasRelation(name)) {
            if (this._related[name]) {
                ...
                this._related[name] = relation.multiple ? models : models[0];
            }
            return;
        }
    ...
    hasRelation: function(name) {
        return this.getRelation(name, false) !== null;
    },
