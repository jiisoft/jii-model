        ...
        getTableSchema: function() {
            if (this._modelSchema === null) {
                ...
                if (!(this._modelSchema instanceof Jii.base.ModelSchema)) {
                    Jii._.each(this._modelSchema.columns, function(column, name) {
                        if (!(column instanceof Jii.base.ModelAttributeSchema)) {
                            ...
                            this._modelSchema.columns[name] = new Jii.base.ModelAttributeSchema(column);
                        }
                    }.bind(this));
                    this._modelSchema = new Jii.base.ModelSchema(this._modelSchema);
                }
            }
