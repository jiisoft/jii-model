...
var self = Jii.defineClass('tests.unit.ValidatorTest', {
    ...
    booleanValidatorTest: function (test) {
        var validator = new Jii.data.validator.BooleanValidator();
    ...
    compareValidatorTest: function (test) {
        ...
        // Attribute
        var validator = new Jii.data.validator.CompareValidator();
    ...
    dateValidatorTest: function (test) {
        var validator = new Jii.data.validator.DateValidator();
    ...
    defaultValueValidatorTest: function(test) {
        ...
        var validator = new Jii.data.validator.DefaultValueValidator();
    ...
    emailValidatorTest: function (test) {
        var validator = new Jii.data.validator.EmailValidator();
    ...
    filterValidatorTest: function (test) {
        var model = new tests.unit.models.FakeValidationModel();
        var validator = new Jii.data.validator.FilterValidator({
    ...
    inlineValidatorTest: function (test) {
        ...
        var validator = new Jii.data.validator.InlineValidator({
            method: 'checkFoo',
            params: {
                param1: 'value1'
            }
    ...
    numberValidatorTest: function (test) {
        ...
        validator = new Jii.data.validator.NumberValidator();
    ...
    rangeValidatorTest: function (test) {
        var validator = new Jii.data.validator.RangeValidator({
            range: [1, 2, 'test']
        });
    ...
    regularExpressionValidatorTest: function (test) {
        var validator = new Jii.data.validator.RegularExpressionValidator({
            pattern: /^[a-z]+[0-9]$/
        });
    ...
    requiredValidatorTest: function (test) {
        var model = new tests.unit.models.FakeValidationModel();
        var validator = new Jii.data.validator.RequiredValidator();
    ...
    safeValidatorTest: function (test) {
        var model = new tests.unit.models.FakeValidationModel();
        var validator = new Jii.data.validator.SafeValidator();
    ...
    stringValidatorTest: function (test) {
        ...
        validator = new Jii.data.validator.StringValidator({
            length: 4
        });
    ...
    urlValidatorTest: function (test) {
        ...
        validator = new Jii.data.validator.UrlValidator();
