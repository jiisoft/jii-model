...
/**
 * @abstract
 * @class Jii.base.BaseActiveRecord
 * @extends Jii.base.Model
 */
var BaseActiveRecord = Jii.defineClass('Jii.base.BaseActiveRecord', /** @lends Jii.base.BaseActiveRecord.prototype */{

	__extends: Model,
	
	__static: /** @lends Jii.base.BaseActiveRecord */{

        /**
         * @event Jii.base.BaseActiveRecord#init
         * @property {Jii.base.Event} event an event that is triggered when the record is initialized via [[init()]].
         */
		EVENT_INIT: 'init',

        /**
         * @event Jii.base.BaseActiveRecord#afterFind
         ...
         * @event Jii.base.BaseActiveRecord#beforeInsert
         ...
         * @event Jii.base.BaseActiveRecord#afterInsert
		...
		/**
		 * @inheritdoc
		 * @returns {Jii.base.BaseActiveRecord} BaseActiveRecord instance matching the condition, or `null` if nothing matches.
		 */
		findOne(condition) {
		...
		/**
		 * @inheritdoc
		 * @returns {Jii.base.BaseActiveRecord[]} an array of BaseActiveRecord instances, or an empty array if nothing matches.
		 */
		findAll(condition) {
		 ...
		 * @returns {Jii.base.BaseActiveRecord|Jii.base.BaseActiveRecord[]}
		 ...
		 *
		 * @param {Jii.base.BaseActiveRecord} record the record to be populated. In most cases this will be an instance
		 ...
		 * @returns {Jii.base.BaseActiveRecord} the newly created active record
		 */
		instantiate(row) {
			return new this(row);
		},
	 ...
	 * @param {Jii.base.BaseActiveRecord|Jii.base.BaseActiveRecord[]|null} records the related records to be populated into the relation.
	 */
     ...
     * @param {string} name
     * @param {string} [prefix]
     * @returns {{model: Jii.base.BaseActiveRecord|null, name: string}|null}
     * @protected
     */
	 ...
	 * @param {Jii.base.BaseActiveRecord} record record to compare to
	 ...
	 * @param {Jii.base.BaseActiveRecord} model the model to be linked with the current one.
	 ...
	 *
	 * @param {string} name the case sensitive name of the relationship.
	 * @param {Jii.base.BaseActiveRecord} model the model to be unlinked from the current one.
	...
	unlinkAll(name, isDelete) {
		...
		return Promise.resolve().then(() => {
			...
			/** @typedef {Jii.base.BaseActiveRecord} relatedModel */
	...
	/**
	 * @param {object} link
	 * @param {Jii.base.BaseActiveRecord} foreignModel
	 * @param {Jii.base.BaseActiveRecord} primaryModel
